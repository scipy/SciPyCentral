...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Revision.item_highlighted_code'
        db.delete_column('submission_revision', 'item_highlighted_code')


    def backwards(self, orm):
        # Adding field 'Revision.item_highlighted_code'
        db.add_column('submission_revision', 'item_highlighted_code',
