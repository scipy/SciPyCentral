...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Revision.enable_reputation'
        db.add_column('submission_revision', 'enable_reputation',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Revision.enable_reputation'
        db.delete_column('submission_revision', 'enable_reputation')
    ...
    models = {
        ...
        'submission.revision': {
            ...
            'enable_reputation': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
