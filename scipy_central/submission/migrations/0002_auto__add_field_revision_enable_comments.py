...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Revision.enable_comments'
        db.add_column('submission_revision', 'enable_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Revision.enable_comments'
        db.delete_column('submission_revision', 'enable_comments')
