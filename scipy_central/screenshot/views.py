...
def add_screenshot(request):
    ...
    if img_form.is_valid():
        ...
        img = models.Screenshot(img_file_raw=img_form.cleaned_data['spc_image_upload'])
        img.save()
        ...
        msg = '<div class="spc-field-error" style="float: left;">%s</div>' %\
                                   img_form.errors.get('spc_image_upload')[0]
        return HttpResponse(msg)
