...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpcComment.reputation'
        db.add_column('comments_spccomment', 'reputation',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpcComment.reputation'
        db.delete_column('comments_spccomment', 'reputation')
