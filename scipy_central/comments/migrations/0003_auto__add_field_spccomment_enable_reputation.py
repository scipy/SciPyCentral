...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpcComment.enable_reputation'
        db.add_column('comments_spccomment', 'enable_reputation',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpcComment.enable_reputation'
        db.delete_column('comments_spccomment', 'enable_reputation')
